...
i18n
  ...
  .init({
    fallbackLng: 'az',
    defaultNS: 'common',
    ns: ['common', 'auth', 'products', 'sales', 'customers', 'inventory', 'reports', 'settings', 'dashboard', 'expenses', 'suppliers', 'users', 'rentals', 'services', 'integrations', 'giftcards', 'orders', 'knowledge', 'modules', 'attendance'],
