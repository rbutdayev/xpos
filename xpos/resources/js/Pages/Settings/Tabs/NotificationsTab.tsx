                ...
                <div className="flex items-start">
                    ...
                    <div className="ml-3">
                        <h3 className="text-sm font-medium text-blue-800">
                            SMS və Telegram Parametrləri
                        </h3>
                        <div className="mt-2 text-sm text-blue-700">
                            <p>
                                SMS və Telegram parametrlərini konfiqurasiya etmək üçün{' '}
                                <a href="/integrations" className="font-medium underline hover:text-blue-900">
                                    Tətbiqlər
                                </a>
                                {' '}səhifəsinə keçin.
                            </p>
