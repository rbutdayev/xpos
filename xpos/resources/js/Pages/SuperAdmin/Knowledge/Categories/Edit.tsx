...
interface KnowledgeCategoriesEditProps {
  category: Category;
  parentCategories: Category[];
}

export default function KnowledgeCategoriesEdit({ category = { id: 0, name: '', slug: '', is_active: true }, parentCategories = [] }: KnowledgeCategoriesEditProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.put(`/admin/knowledge/categories/${category?.id}`, formData, {
      onError: (errors) => {
