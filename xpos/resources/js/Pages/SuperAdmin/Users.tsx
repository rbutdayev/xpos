                ...
                <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="mb-8">
                        <nav className="flex space-x-4">
                            ...
                            <a href="/admin/accounts" className="text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">
                                Hesablar
                            </a>
                            <a href="/admin/users" className="bg-blue-100 text-blue-700 px-3 py-2 rounded-md text-sm font-medium">
                                İstifadəçilər
                            </a>
