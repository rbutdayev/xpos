...
export default function Create({ customers }: Props) {
    ...
    return (
        ...
        >
            <Head title="Yeni müştəri məhsulu" />
                ...
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    ...
                    <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <ul className="text-sm text-blue-700 space-y-1">
                            <li>• Müştəri, məhsul növü və təsvir mütləq sahələrdir</li>
                            ...
                            <li>• Məhsul yaradıldıqdan sonra ona terzi xidmətləri əlavə edə bilərsiniz</li>
                        </ul>
                    </div>
                </div>
            </div>
