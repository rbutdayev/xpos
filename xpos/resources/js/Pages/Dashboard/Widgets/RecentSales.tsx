        ...
        <div className="-m-6 p-6">
            ...
            {sales.length > 0 ? (
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center text-sm">
                                        ...
                                        <span className="font-medium text-gray-900 truncate" title={sale.customer_name || 'Anonim müştəri'}>
                                            {sale.customer_name || 'Anonim müştəri'}
                                        </span>
                                    ...
                                    <div className="flex items-center mt-1 text-xs text-gray-500">
                                        ...
                                        <span>{sale.items_count} məhsul</span>
                                    </div>
                                </div>
                ...
                <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 mt-2">Son satış tapılmadı</p>
                </div>
            )}
        </div>
    );
