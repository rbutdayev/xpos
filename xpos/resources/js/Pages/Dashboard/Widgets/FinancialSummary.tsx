...
const FinancialSummary = memo(function FinancialSummary({ data, period }: FinancialSummaryProps) {
    ...
    const financialHealthStatus = useMemo(() => {
        if (profitMargin >= 20) return { status: 'Əla', color: 'text-green-600' };
        if (profitMargin >= 10) return { status: 'Yaxşı', color: 'text-yellow-600' };
        if (profitMargin >= 0) return { status: 'Orta', color: 'text-orange-600' };
        return { status: 'Zəif', color: 'text-red-600' };
    }, [profitMargin]);

    return (
        <div className="-m-6 p-6">
            <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-gray-900">Maliyyə Xülasəsi</h3>
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-green-800">Gəlir</p>
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-red-800">Xərclər</p>
            ...
            <div className={`p-4 rounded-lg mb-4 ${
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <p className="text-xs text-gray-600">Mənfəət Marjı</p>
            ...
            {data.pending_payments > 0 && (
                <div className="bg-yellow-50 p-4 rounded-lg">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm font-medium text-yellow-800">Gözləyən Ödənişlər</p>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
                <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Maliyyə Vəziyyəti:</span>
