...
export default function StockImportModal({ isOpen, onClose, onImportStarted }: StockImportModalProps) {
    ...
    const handleDownloadTemplate = () => {
        window.location.href = '/product-stock/import/template';
    };
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await axios.post('/product-stock/import', formData, {
                headers: {
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                        ...
                                        <ol className="list-decimal list-inside text-sm text-blue-800 space-y-1">
                                            ...
                                            <li>Excel faylını məhsul və anbar məlumatları ilə doldurun</li>
                                            <li className="font-bold text-blue-900">
                                                ⚠️ ƏSAS: <span className="text-red-700">BARKOD</span> mütləq daxil edin (məhsulu tapmaq üçün)
                                            </li>
                                            <li>SKU yalnız barkod olmayan məhsullar üçün istifadə edin</li>
                                            <li><strong>Anbar adı</strong> və <strong>miqdar</strong> mütləq daxil edin</li>
                                            <li>Məhsul adı sütunu məlumat üçündür (optional)</li>
