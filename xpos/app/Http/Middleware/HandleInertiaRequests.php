...
class HandleInertiaRequests extends Middleware
{
    ...
    public function share(Request $request): array
    {
        ...
        return [
            ...
            'loyaltyEnabled' => $user && $user->account ? ($user->account->loyalty_module_enabled ?? true) : false,
            'servicesEnabled' => $user && $user->account ? ($user->account->services_module_enabled ?? true) : true,
            'rentEnabled' => $user && $user->account ? ($user->account->rent_module_enabled ?? true) : true,
            'discountsEnabled' => $user && $user->account ? ($user->account->discounts_module_enabled ?? true) : true,
            'flash' => [
