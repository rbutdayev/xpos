...
class ProcessStockImport implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            \Log::error('Stock import job failed: ' . $e->getMessage(), [
    ...
    {
        \Log::error('Stock import job failed critically: ' . $exception->getMessage(), [
            'import_job_id' => $this->importJob->id,
