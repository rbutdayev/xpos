...
export default function PaymentModal({ isOpen, onClose }: PaymentModalProps) {
  const { items, customer, total, taxAmount, payments, addPayment, removePayment, clearCart, notes } = useCartStore();
  ...
  const handleCompleteSale = async () => {
    ...
    try {
      ...
      const sale: Sale = {
        ...
        user_id: config.user_id || 1, // Default to 1 for old version
