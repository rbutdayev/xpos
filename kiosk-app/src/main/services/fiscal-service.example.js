...
exports.initializeFiscalPrinter = initializeFiscalPrinter;
exports.testFiscalConnection = testFiscalConnection;
exports.printSaleReceiptExample = printSaleReceiptExample;
exports.completeSaleWithFiscal = completeSaleWithFiscal;
exports.saleWithMixedPayments = saleWithMixedPayments;
exports.saleWithGiftCard = saleWithGiftCard;
exports.creditSale = creditSale;
exports.saleWithRetry = saleWithRetry;
exports.checkShiftStatus = checkShiftStatus;
exports.createKioskSale = createKioskSale;
...
async function initializeFiscalPrinter() {
    ...
    try {
        await fiscal_service_1.fiscalService.initialize(config);
        console.log('Fiscal printer initialized successfully');
        console.log('Provider:', fiscal_service_1.fiscalService.getProviderName());
    }
    catch (error) {
...
async function testFiscalConnection() {
    const result = await fiscal_service_1.fiscalService.testConnection();
    if (result.success) {
...
async function printSaleReceiptExample() {
    ...
    try {
        const result = await fiscal_service_1.fiscalService.printSaleReceipt(sale);
        if (result.success) {
...
// ============================================================================
async function completeSaleWithFiscal(saleData) {
    ...
    try {
        const fiscalResult = await fiscal_service_1.fiscalService.printSaleReceipt(saleData);
...
// ============================================================================
async function saleWithRetry(sale, maxRetries = 1) {
    let attempts = 0;
...
async function checkShiftStatus() {
    const status = await fiscal_service_1.fiscalService.getShiftStatus();
    if (status.isOpen) {
 ...
 */
async function createKioskSale(saleData) {
    ...
    try {
        if (fiscal_service_1.fiscalService.isInitialized()) {
            const fiscalResult = await fiscal_service_1.fiscalService.printSaleReceipt(saleData);
            if (fiscalResult.success) {
...
//# sourceMappingURL=fiscal-service.example.js.map